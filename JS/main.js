...
let allImgs = document.querySelectorAll(".places-container .wrapper img");
allImgs.forEach((img, index) => {
  img.addEventListener("click", () => {
    ...
    // Set the place name and info as the content of the popUp-info div
    popUpInfo.innerHTML = `<h2>${placeName}</h2><p>${placeInfo}</p>`;
